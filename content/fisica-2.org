...
Relembre os conceitos de [[file:area.org][Área]] ,  [[file:volume.org][volume]] e  [[file:densidade.org][densidade]] .
...
<div style="text-align:center; max-width:700px; margin:auto;">
 ...
 FÍGURA : Pressão = força por área
  </p>
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/Pressure_force_area.svg/500px-Pressure_force_area.svg.png"
       alt=alt="Pressure"
       style="width:80%; height:auto;">
  <p style="font-size:0.75em; color:gray;">
    Fonte: <a href="https://commons.wikimedia.org/wiki/File:Pressure_force_area.svg">Klaus-Dieter Keller</a>, Public domain, via Wikimedia Commons
...
<div style="text-align:center; max-width:700px; margin:auto;">
 ...
 FÍGURA : Exemplo de como um mesmo objeto (mesma força peso) pode exercer diferentes valores de pressão.
  ...
  <img src="https://commons.wikimedia.org/wiki/File:Pressure_schematic.svg"
       alt="Pressure schematic" 
       style="width:80%; height:auto;">
  <p style="font-size:0.75em; color:gray;">
    Fonte: <a title="すじにくシチュー, CC0, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:Pressure_schematic.svg"><img width="960"
    src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/Pressure_schematic.svg/960px-Pressure_schematic.svg.png"></a>, CC0, via Wikimedia Commons
    <img src="https://mirrors.creativecommons.org/presskit/icons/cc.svg" style="height: 1em;" />
    <img src="https://mirrors.creativecommons.org/presskit/icons/zero.svg" style="height: 1em;" />
  </p>
</div>
...
- ondas eletromagnéticas como a luz são ondas transverdais, e por isso
  podem haver polarização
...
https://phet.colorado.edu/sims/html/sound-waves/latest/sound-waves_all.html?locale=pt_BR

https://phet.colorado.edu/pt_BR/simulations/fourier-making-waves
https://phet.colorado.edu/pt_BR/simulations/wave-on-a-string

https://phet.colorado.edu/pt_BR/simulations/wave-interference


** [[file:quest-fis2-u3.org][Unidade 3]] 
