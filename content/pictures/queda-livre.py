# Criar e salvar o script Python, com blit=False

script_queda_livre_corrigido = """
import numpy as np
...
file_path_corrigido = "queda-livre-corrigido.py"
with open(file_path_corrigido, "w") as f:
    f.write(script_queda_livre_corrigido)
