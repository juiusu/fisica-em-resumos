...
b) Complete a tabela abaixo com quatro pares de valores (massa e volume) que sejam compatíveis com essa densidade. Lembre-se: \(\text{densidade} = \frac{\text{massa}}{\text{volume}}\).
