...
Nessas páginas serão sistematizados resumos dos temas abordados em
aula, nas disciplinas ministradas pelo Prof. Joilson - IFAM/CMC.

O objetivo é construir um material de consulta aos estudantes ao longo
do desenvolvimento das disciplinas, sem a pretenção de ser um material completo.
...
* [[file:fisica-aplicada-TA.org][FÍSICA APLICADA: curso superior em tecnologia de alimentos]]

* [[file:fisica-aplicada-TPQ.org][FÍSICA APLICADA: Curso Superior de Tecnologia em Processos Químicos]]
* 
...
- [[https://www.gov.br/mec/pt-br/mec-enem][MEC-ENEM (simulados)]]
...
[[file:./pictures/ifam-logo.png]]    Insituto Federal do Amazonas -
