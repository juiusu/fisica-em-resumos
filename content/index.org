...
* Introdução
Nessa página serão resumidas as aulas de **física** dos Cursos Técnicos de Nível Médio em Informática, Administração e Agropecuária na Forma Integrada, do IFAM /Campus/ Eirunepé; ministradas no ano de 2026.
...
** [[file:revisao-prova1-fis1.org][Questões de revisão - Prova 1 - 1º ano]]

* [[file:fisica-1.org][Física I]]

* [[file:fisica-2.org][Física II]]

** [[file:revisao-prova1-fis2.org][Questões de revisão - Prova 1 - 2º ano]]

* [[file:fisica-3.org][Física III]]

** [[file:revisao-prova1-fis3.org][Questões de revisão - Prova 1 - 3º ano]]
