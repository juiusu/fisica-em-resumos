...
href="https://commons.wikimedia.org/wiki/File:Displacement-measurement.svg"><img width="512" alt="Displacement-measurement" src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Displacement-measurement.svg/512px-Displacement-measurement.svg.png?20220412171225"></a>
#+END_EXPORT
#+end_comment
...
#+BEGIN_EXPORT html
<a title="Cmglee, CC BY-SA 4.0 &lt;https://creativecommons.org/licenses/by-sa/4.0&gt;, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:Visualisation_litre_gram.svg"><img width="500" alt="Visualisation litre gram" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Visualisation_litre_gram.svg/500px-Visualisation_litre_gram.svg.png?utm_source=commons.wikimedia.org&utm_campaign=index&utm_content=thumbnail"></a>
#+END_EXPORT


Visualização de 1 litro, 1 centilitro, 1 mililitro, 1 microlitro e da
massa correspondente aproximada de água, por CMG Lee.
